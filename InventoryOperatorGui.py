...
class InventoryOperatorGUI ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Inventory Operator", pos = wx.DefaultPosition, size = wx.Size( 700,750 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		bSizer71.Add( self.m_treeCtrlSelectionsUpdate, 1, wx.EXPAND|wx.TOP|wx.RIGHT|wx.LEFT, 5 )
		...
		bSizer12.Add( self.m_staticText33, 0, wx.ALL, 5 )
		...
		sbSizer51.Add( bSizer101, 0, wx.EXPAND|wx.TOP|wx.BOTTOM, 0 )
		...
		sbSizer6.Add( fgSizer61, 0, 0, 0 )


		bSizer9.Add( sbSizer6, 0, wx.EXPAND, 0 )
		...
		self.m_buttonInventryUpdateWithDictFolder.Bind( wx.EVT_BUTTON, self.m_buttonInventryUpdateWithDictFolderOnButtonClick )
